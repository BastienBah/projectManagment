...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { configfile: @version.configfile, wcm: @version.wcm } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { configfile: @version.configfile, wcm: @version.wcm } }
